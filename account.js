...
function showBilling(row) {
  ...
  var UP = {
    starter: { to: 'business', text: 'For £25 more, Business adds bookings, payments and forms, reviews asked for automatically, live chat, and unlimited changes made by us within 48 hours. ' },
